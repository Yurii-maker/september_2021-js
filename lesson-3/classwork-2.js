...
//     document.write(`<div class="simpson"><h2>NAME - ${simpson.name} SURNAME - ${simpson.surname} AGE - ${simpson.age}</h2><p>INFO - ${simpson.info}</p>  <img src="${simpson.photo}" alt="Personage"></div>`)
//
// }
...
//     document.write(`<div class = "product-card"><h3 class="product-title">${product.title}. Price - ${product.price}</h3> <img class="product-image" src="${product.image}" alt="Product"></div>`)
// }
