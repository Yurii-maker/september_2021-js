...
// //     block.innerText = `${simpson.name} ${simpson.surname} -  ${simpson.age}`;
...
//     tittle.innerText = `${simpson.name} ${simpson.surname} - ${simpson.age}`;
//     let info = document.createElement('h2');
//     info.innerText = `${simpson.info}`;
//     let photo = document.createElement('img');
//     photo.src = `${simpson.photo}`;
//     block.append(tittle, info, photo);
//     document.body.appendChild(block)
// }
...
//
//     }
//     block.append(tittle, monthDuration, hourDuration, modules);
//     document.body.appendChild(block)
//
// }